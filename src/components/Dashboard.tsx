              ...
              <div className="bg-white/5 rounded-2xl p-5 border border-white/10">
                ...
                <div className="space-y-3">
                  <div className="flex items-start gap-2">
                    ...
                    <div className="bg-cyan-500/10 rounded-xl rounded-tl-none px-3 py-2 text-xs text-slate-300">
                  ...
                  <div className="flex items-start gap-2">
                    ...
                    <div className="bg-white/5 rounded-xl rounded-tl-none px-3 py-2 text-xs text-slate-300">
                      Let me break this down step by step...
                    </div>
                  </div>
                </div>
                <div className="mt-4 h-8 bg-white/5 rounded-lg flex items-center px-3">
